...
def urllist_flickr(keywords):
    ...
    """
    url = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=4252dc8b7b9a608ea19a753a2b17b0ab&text="+keywords.replace(" ","+")+"&format=rest"
    page = urlopen(url)
    ...
    for i in range(1,nump):
        url = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=4252dc8b7b9a608ea19a753a2b17b0ab&text="+keywords.replace(" ","+")+"&format=rest&page="+str(i)
        page = urlopen(url)
        soup = BeautifulSoup(page,"lxml")
